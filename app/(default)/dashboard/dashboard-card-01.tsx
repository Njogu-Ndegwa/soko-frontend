...
//             <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">{summary?.totalCustomers || '0'}</div>
//             <div className="text-xs text-gray-500 dark:text-gray-400">Total Customers</div>
//           </div>
          
//           <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
//             <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">{summary?.activeCustomers || '0'}</div>
//             <div className="text-xs text-gray-500 dark:text-gray-400">Active Customers</div>
//           </div>
          
//           <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
//             <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">KES {summary?.monthlyRevenue?.toLocaleString() || '0'}</div>
//             <div className="text-xs text-gray-500 dark:text-gray-400">Monthly Revenue</div>
//           </div>
          
//           <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
//             <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">{summary?.thisMonthCustomers || '0'}</div>
//             <div className="text-xs text-gray-500 dark:text-gray-400">New This Month</div>
//           </div>
          
//           <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
//             <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Last Payment</div>
//             <div className="text-lg font-bold text-gray-800 dark:text-gray-100">{formatLastPayment(summary?.lastPaymentDate || '')}</div>
//           </div>
//         </div>
//       </div>
//     </div>
