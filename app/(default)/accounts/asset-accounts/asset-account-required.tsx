      ...
      <div className="p-6">
        <div className="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            {`Link a ${stageName.toLowerCase()} to your asset account`}
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-md text-center">
            ...
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Asset Account Required</h2>
            <p className="text-gray-500 dark:text-gray-400 mb-6">
              {`You need to create an asset account before you can link a ${stageName.toLowerCase()}.`}
              Please complete the asset account creation process first.
            </p>
            <button
              type="button"
              onClick={() => router.back()}
