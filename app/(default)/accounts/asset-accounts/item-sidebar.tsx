    ...
    return (
     ...
     _               <li className="mr-0.5 md:mr-0 md:mb-0.5">
                    ...
                    <li className="mr-0.5 md:mr-0 md:mb-0.5">
                        ...
                        >
                            <svg
                                className={`shrink-0 fill-current mr-2 ${pathname.includes('/accounts/asset-accounts/link-payplan')
                                        ? 'text-violet-500 dark:text-violet-400'
                                        : 'text-gray-400 dark:text-gray-500'
                                    }`}
                                width="16"
                    ...
                    <li className="mr-0.5 md:mr-0 md:mb-0.5">
                        ...
                        >
                            <svg
                                className={`shrink-0 fill-current mr-2 ${pathname.includes('/accounts/asset-accounts/code-generation')
                                        ? 'text-violet-500 dark:text-violet-400'
                                        : 'text-gray-400 dark:text-gray-500'
                                    }`}
                                width="16"
                    ...
                    <li className="mr-0.5 md:mr-0 md:mb-0.5">
                        ...
                        >
                            <svg
                                className={`shrink-0 fill-current mr-2 ${pathname.includes('/accounts/asset-accounts/code-history')
                                        ? 'text-violet-500 dark:text-violet-400'
                                        : 'text-gray-400 dark:text-gray-500'
                                    }`}
                                width="16"
                    ...
                    <li className="mr-0.5 md:mr-0 md:mb-0.5">
                        ...
                        >
                            <svg
                                className={`shrink-0 fill-current mr-2 ${pathname.includes('/accounts/asset-accounts/payments')
                                        ? 'text-violet-500 dark:text-violet-400'
                                        : 'text-gray-400 dark:text-gray-500'
                                    }`}
                                width="16"
