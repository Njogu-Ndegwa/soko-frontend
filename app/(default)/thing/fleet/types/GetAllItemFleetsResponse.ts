...
// ====================================================
// GraphQL fragment: GetAllItemFleetsResponse
// ====================================================

export interface GetAllItemFleetsResponse_page_edges_node_distributor_orgContactPerson {
  __typename: "Person";
  _id: string;
  name: string;
}

export interface GetAllItemFleetsResponse_page_edges_node_distributor {
  __typename: "Distributor";
  _id: string;
  orgContactPerson: GetAllItemFleetsResponse_page_edges_node_distributor_orgContactPerson | null;
}

export interface GetAllItemFleetsResponse_page_edges_node_itemList {
  __typename: "Item";
  _id: string;
  description: string;
  /**
...
export interface GetAllItemFleetsResponse_page_edges_node {
  ...
  distributor: GetAllItemFleetsResponse_page_edges_node_distributor | null;
  fleetName: string;
  itemList: GetAllItemFleetsResponse_page_edges_node_itemList[] | null;
  profile: string | null;
  type: ActorTypes;
  updatedAt: any | null;
}

export interface GetAllItemFleetsResponse_page_edges {
  __typename: "ItemFleetEdge";
  cursor: string | null;
  node: GetAllItemFleetsResponse_page_edges_node | null;
}

export interface GetAllItemFleetsResponse_page_pageInfo {
...
export interface GetAllItemFleetsResponse_page {
  __typename: "ItemFleetConnection";
  edges: GetAllItemFleetsResponse_page_edges[] | null;
  pageInfo: GetAllItemFleetsResponse_page_pageInfo | null;
}

export interface GetAllItemFleetsResponse_pageData {
  __typename: "PageData";
  count: number;
  limit: number;
  offset: number;
...
export interface GetAllItemFleetsResponse {
  __typename: "GetAllItemFleetsResponse";
  page: GetAllItemFleetsResponse_page;
  pageData: GetAllItemFleetsResponse_pageData | null;
}
