...
import { UpdateItemFleetInput, ActionScope, ActorTypes } from "./../../types/globalTypes";

// ====================================================
// GraphQL mutation operation: UpdateItemFleet
// ====================================================

export interface UpdateItemFleet_updateItemFleet_distributor_orgContactPerson {
  __typename: "Person";
  _id: string;
  name: string;
}

export interface UpdateItemFleet_updateItemFleet_distributor {
  __typename: "Distributor";
  _id: string;
  orgContactPerson: UpdateItemFleet_updateItemFleet_distributor_orgContactPerson | null;
}

export interface UpdateItemFleet_updateItemFleet_itemList {
  __typename: "Item";
  _id: string;
  description: string;
  /**
...
export interface UpdateItemFleet_updateItemFleet {
  ...
  distributor: UpdateItemFleet_updateItemFleet_distributor | null;
  fleetName: string;
  itemList: UpdateItemFleet_updateItemFleet_itemList[] | null;
  profile: string | null;
  type: ActorTypes;
  updatedAt: any | null;
}

export interface UpdateItemFleet {
  updateItemFleet: UpdateItemFleet_updateItemFleet;
}

export interface UpdateItemFleetVariables {
