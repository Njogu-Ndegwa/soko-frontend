...
// ====================================================
// GraphQL fragment: ItemFleet
// ====================================================

export interface ItemFleet_distributor_orgContactPerson {
  __typename: "Person";
  _id: string;
  name: string;
}

export interface ItemFleet_distributor {
  __typename: "Distributor";
  _id: string;
  orgContactPerson: ItemFleet_distributor_orgContactPerson | null;
}

export interface ItemFleet_itemList {
  __typename: "Item";
  _id: string;
  description: string;
  /**
...
export interface ItemFleet {
  ...
  distributor: ItemFleet_distributor | null;
  fleetName: string;
  itemList: ItemFleet_itemList[] | null;
  profile: string | null;
  type: ActorTypes;
  updatedAt: any | null;
}
