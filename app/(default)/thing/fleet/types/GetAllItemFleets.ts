...
// ====================================================
// GraphQL query operation: GetAllItemFleets
// ====================================================

export interface GetAllItemFleets_getAllItemFleets_page_edges_node_distributor_orgContactPerson {
  __typename: "Person";
  _id: string;
  name: string;
}

export interface GetAllItemFleets_getAllItemFleets_page_edges_node_distributor {
  __typename: "Distributor";
  _id: string;
  orgContactPerson: GetAllItemFleets_getAllItemFleets_page_edges_node_distributor_orgContactPerson | null;
}

export interface GetAllItemFleets_getAllItemFleets_page_edges_node_itemList {
  __typename: "Item";
  _id: string;
  description: string;
  /**
...
export interface GetAllItemFleets_getAllItemFleets_page_edges_node {
  ...
  distributor: GetAllItemFleets_getAllItemFleets_page_edges_node_distributor | null;
  fleetName: string;
  itemList: GetAllItemFleets_getAllItemFleets_page_edges_node_itemList[] | null;
  profile: string | null;
  type: ActorTypes;
  updatedAt: any | null;
}

export interface GetAllItemFleets_getAllItemFleets_page_edges {
  __typename: "ItemFleetEdge";
  cursor: string | null;
  node: GetAllItemFleets_getAllItemFleets_page_edges_node | null;
}

export interface GetAllItemFleets_getAllItemFleets_page_pageInfo {
...
export interface GetAllItemFleets_getAllItemFleets_page {
  __typename: "ItemFleetConnection";
  edges: GetAllItemFleets_getAllItemFleets_page_edges[] | null;
  pageInfo: GetAllItemFleets_getAllItemFleets_page_pageInfo | null;
}
...
export interface GetAllItemFleets_getAllItemFleets {
  ...
  page: GetAllItemFleets_getAllItemFleets_page;
  pageData: GetAllItemFleets_getAllItemFleets_pageData | null;
}

export interface GetAllItemFleets {
  getAllItemFleets: GetAllItemFleets_getAllItemFleets;
}

export interface GetAllItemFleetsVariables {
  after?: string | null;
  before?: string | null;
  first?: number | null;
  last?: number | null;
