...
import { UpdateItemFleetCodeGenInput, ActionScope, ActorTypes } from "./../../types/globalTypes";

// ====================================================
// GraphQL mutation operation: UpdateItemFleetCodeGen
// ====================================================

export interface UpdateItemFleetCodeGen_updateItemFleetCodeGen_distributor_orgContactPerson {
  __typename: "Person";
  _id: string;
  name: string;
}

export interface UpdateItemFleetCodeGen_updateItemFleetCodeGen_distributor {
  __typename: "Distributor";
  _id: string;
  orgContactPerson: UpdateItemFleetCodeGen_updateItemFleetCodeGen_distributor_orgContactPerson | null;
}

export interface UpdateItemFleetCodeGen_updateItemFleetCodeGen_itemList {
  __typename: "Item";
  _id: string;
  description: string;
  /**
...
export interface UpdateItemFleetCodeGen_updateItemFleetCodeGen {
  ...
  distributor: UpdateItemFleetCodeGen_updateItemFleetCodeGen_distributor | null;
  fleetName: string;
  itemList: UpdateItemFleetCodeGen_updateItemFleetCodeGen_itemList[] | null;
  profile: string | null;
  type: ActorTypes;
  updatedAt: any | null;
}

export interface UpdateItemFleetCodeGen {
  updateItemFleetCodeGen: UpdateItemFleetCodeGen_updateItemFleetCodeGen;
}

export interface UpdateItemFleetCodeGenVariables {
