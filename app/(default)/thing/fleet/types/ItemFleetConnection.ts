...
// ====================================================
// GraphQL fragment: ItemFleetConnection
// ====================================================

export interface ItemFleetConnection_edges_node_distributor_orgContactPerson {
  __typename: "Person";
  _id: string;
  name: string;
}

export interface ItemFleetConnection_edges_node_distributor {
  __typename: "Distributor";
  _id: string;
  orgContactPerson: ItemFleetConnection_edges_node_distributor_orgContactPerson | null;
}

export interface ItemFleetConnection_edges_node_itemList {
  __typename: "Item";
  _id: string;
  description: string;
  /**
...
export interface ItemFleetConnection_edges_node {
  ...
  distributor: ItemFleetConnection_edges_node_distributor | null;
  fleetName: string;
  itemList: ItemFleetConnection_edges_node_itemList[] | null;
  profile: string | null;
  type: ActorTypes;
  updatedAt: any | null;
}

export interface ItemFleetConnection_edges {
  __typename: "ItemFleetEdge";
  cursor: string | null;
  node: ItemFleetConnection_edges_node | null;
}

export interface ItemFleetConnection_pageInfo {
...
export interface ItemFleetConnection {
  __typename: "ItemFleetConnection";
  edges: ItemFleetConnection_edges[] | null;
  pageInfo: ItemFleetConnection_pageInfo | null;
}
