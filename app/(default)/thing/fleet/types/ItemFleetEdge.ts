...
// ====================================================
// GraphQL fragment: ItemFleetEdge
// ====================================================

export interface ItemFleetEdge_node_distributor_orgContactPerson {
  __typename: "Person";
  _id: string;
  name: string;
}

export interface ItemFleetEdge_node_distributor {
  __typename: "Distributor";
  _id: string;
  orgContactPerson: ItemFleetEdge_node_distributor_orgContactPerson | null;
}

export interface ItemFleetEdge_node_itemList {
  __typename: "Item";
  _id: string;
  description: string;
  /**
...
export interface ItemFleetEdge_node {
  ...
  distributor: ItemFleetEdge_node_distributor | null;
  fleetName: string;
  itemList: ItemFleetEdge_node_itemList[] | null;
  profile: string | null;
  type: ActorTypes;
  updatedAt: any | null;
}

export interface ItemFleetEdge {
  __typename: "ItemFleetEdge";
  cursor: string | null;
  node: ItemFleetEdge_node | null;
}
