...
//                 All <span className="ml-1 text-gray-400 dark:text-gray-500">{statusCounts.all}</span>
//               </button>
//             </li>
//             <li className="m-1">
//               <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 text-gray-500 dark:text-gray-400 transition">
//                 Active <span className="ml-1 text-green-500">{statusCounts.active}</span>
//               </button>
//             </li>
//             <li className="m-1">
//               <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 text-gray-500 dark:text-gray-400 transition">
//                 Inactive <span className="ml-1 text-red-500">{statusCounts.inactive}</span>
//               </button>
//             </li>
//             <li className="m-1">
//               <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 text-gray-500 dark:text-gray-400 transition">
//                 Suspended <span className="ml-1 text-yellow-500">{statusCounts.suspended}</span>
//               </button>
//             </li>
//           </ul>
//         </div>
